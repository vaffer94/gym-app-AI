...
export default function ObiettivoEnergia(props) {
  return (
    ...
    <rect x="6" y="10" width="15" height="1"/>
    <rect x="5" y="11" width="16" height="1"/>
    <rect x="3" y="12" width="16" height="1"/>
    <rect x="3" y="13" width="15" height="1"/>
