// 🎉 (fine allenamento) — pixellata da twemoji, CC-BY 4.0 — attribuzione richiesta
...
export default function Festa(props) {
  return (
    ...
    <rect x="20" y="19" width="4" height="1"/>
    ...
    <rect x="17" y="10" width="7" height="1"/>
