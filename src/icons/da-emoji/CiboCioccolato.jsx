...
export default function CiboCioccolato(props) {
  return (
    ...
    <rect x="1" y="6" width="11" height="1"/>
    ...
    <g fill="var(--ico-b, #ccd6dd)">
    <rect x="13" y="5" width="2" height="1"/>
    <rect x="12" y="6" width="4" height="1"/>
