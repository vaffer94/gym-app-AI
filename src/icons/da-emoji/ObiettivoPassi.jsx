...
export default function ObiettivoPassi(props) {
  return (
    ...
    <rect x="6" y="14" width="6" height="1"/>
    <rect x="8" y="15" width="5" height="1"/>
    <rect x="9" y="16" width="4" height="1"/>
    ...
    <rect x="18" y="22" width="4" height="1"/>
    </g>
    </svg>
  )
}
